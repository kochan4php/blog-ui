...
const Navbar = () => (
  <header className="bg-transparent w-full py-6 mb-2 md:mb-6">
    <div className="container">
      <div className="flex justify-between items-center w-full relative px-1 md:px-0">
        <button
          ...
          >
            <ul className="flex flex-col lg:flex-row justify-between items-center w-full">
              <li className="px-6 py-4 md:px-8 md:py-5 lg:p-0 text-slate-300 hover:text-slate-400 group transition-colors duration-200">
                <button className="flex items-center justify-center gap-1 hover:text-slate-400">
        ...
        <div className="md:hidden text-slate-300 cursor-pointer hover:text-slate-400 transiton duration-300 text-sm">
          <svg
            xmlns="http://www.w3.org/2000/svg"
